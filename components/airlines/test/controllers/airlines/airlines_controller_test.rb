  ...
  class AirlinesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create airline" do
      assert_difference('Airline.count') do
        post airlines_url, params: { airline: { country: @airline.country, name: @airline.name } }
      end
    ...
    test "should update airline" do
      patch airline_url(@airline), params: { airline: { country: @airline.country, name: @airline.name } }
